...
python dvp_video_consistency.py --max_epoch 5 --input demo/consistency/colorization/goat_input --processed demo/consistency/colorization/goat_processed --task colorization --with_IRT 1 --IRT_initialization 1 --output result/colorization
